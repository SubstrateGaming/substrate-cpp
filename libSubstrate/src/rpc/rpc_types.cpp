...
// Digest
//
substrate::encoder &substrate::rpc::operator<<(substrate::encoder &encoder, const Digest &v)
{
   throw std::runtime_error("not implemented");
}

substrate::decoder &substrate::rpc::operator>>(substrate::decoder &decoder, Digest &v)
{
   throw std::runtime_error("not implemented");
}
...
// Header
//
substrate::encoder &substrate::rpc::operator<<(substrate::encoder &encoder, const Header &v)
{
   throw std::runtime_error("not implemented");
}

substrate::decoder &substrate::rpc::operator>>(substrate::decoder &decoder, Header &v)
{
   throw std::runtime_error("not implemented");
}
...
Era Era::make(uint32_t lifeTime, uint64_t finalizedHeaderBlockNumber)
{
   throw std::runtime_error("not implemented");
}
