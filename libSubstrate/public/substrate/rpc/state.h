...
namespace substrate::rpc
{
   ...
   public:
       ...
       * @return Bytes
       */
      virtual Bytes state_call(Text method, Bytes data, BlockHash at = {}) = 0;
       ...
       */
      virtual Vec<StorageKey> state_getChildKeys(StorageKey childStorageKey, StorageKey childDefinition, u32 childType, StorageKey key, BlockHash at = {}) = 0;
       ...
       * @return ReadProof
       */
      virtual ReadProof state_getChildReadProof(PrefixedStorageKey childStorageKey, Vec<StorageKey> keys, BlockHash at = {}) = 0;
       ...
       * @return StorageData
       */
      virtual StorageData state_getChildStorage(StorageKey childStorageKey, StorageKey childDefinition, u32 childType, StorageKey key, BlockHash at = {}) = 0;
       ...
       * @return Hash
       */
      virtual Hash state_getChildStorageHash(StorageKey childStorageKey, StorageKey childDefinition, u32 childType, StorageKey key, BlockHash at = {}) = 0;
       ...
       * @return u64
       */
      virtual u64 state_getChildStorageSize(StorageKey childStorageKey, StorageKey childDefinition, u32 childType, StorageKey key, BlockHash at = {}) = 0;
       ...
       * @return Vec<StorageKey>
       */
      virtual Vec<StorageKey> state_getKeys(StorageKey key, BlockHash at = {}) = 0;
       ...
       * @return Vec<StorageKey>
       */
      virtual Vec<StorageKey> state_getKeysPaged(StorageKey key, u32 count, StorageKey startKey = {}, BlockHash at = {}) = 0;
       ...
       * @return Metadata
       */
      virtual Metadata state_getMetadata(BlockHash at = {}) = 0;
       ...
       * @return Vec<KeyValue>
       */
      virtual Vec<KeyValue> state_getPairs(StorageKey prefix, BlockHash at = {}) = 0;
       ...
       * @return ReadProof
       */
      virtual ReadProof state_getReadProof(Vec<StorageKey> keys, BlockHash at = {}) = 0;
       ...
       */
      virtual RuntimeVersion state_getRuntimeVersion(BlockHash at = {}) = 0;
       ...
       * @return StorageData
       */
      virtual StorageData state_getStorage(StorageKey key, BlockHash at = {}) = 0;
       ...
       * @return Hash
       */
      virtual Hash state_getStorageHash(StorageKey key, BlockHash at = {}) = 0;
       ...
       * @return u64
       */
      virtual u64 state_getStorageSize(StorageKey key, BlockHash at = {}) = 0;
       ...
       */
      virtual Vec<StorageChangeSet> state_queryStorage(Vec<StorageKey> keys, Hash fromBlock, BlockHash toBlock = {}) = 0;
       ...
       * @return Vec<StorageChangeSet>
       */
      virtual Vec<StorageChangeSet> state_queryStorageAt(Vec<StorageKey> keys, BlockHash at = {}) = 0;
       ...
       */
      virtual StorageChangeSet state_subscribeStorage(Vec<StorageKey> keys = {}) = 0;
       ...
       */
      virtual MigrationStatusResult state_trieMigrationStatus(BlockHash at = {}) = 0;
   };
}
